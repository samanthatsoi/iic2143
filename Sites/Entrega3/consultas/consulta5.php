...
<h2>Ver la habitaci&oacuten que ha sido reservada m&aacutes veces en cada region:</h2>
<br/>
<form class=form action="backend_consultas/consulta5.2.php" method="post">
