...
<h2>Ver todos los usuarios que han reservado la habitaci&oacuten m&aacutes barata en la regi&oacuten II.</h2>
<br/>
<form class=form action="backend_consultas/consulta6.2.php" method="post">
